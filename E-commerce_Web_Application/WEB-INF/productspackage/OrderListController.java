...
String url="";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HttpSession userorder = request.getSession();
            ...
            String loginuser="";
             ...
             action="MyOrder";
              ...
              if(action.equals("MyOrder")) {
                  loginuser = (String) userorder.getAttribute("theuser");
                   if((loginuser.equals(olyuser.getUserOrder(loginuser).getUserID()))) {
                       
                       olist = olyuser.getUserOrderList(loginuser);
                       list.setAttribute("theOrders", olist);
