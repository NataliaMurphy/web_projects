 ...
 * @author Arj
 */
@WebServlet(name = "UpdateFlightController", urlPatterns = {"/UpdateFlightController"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            FlightDB u = new FlightDB();
                ...
                if((flightnumber.equals(u.getFlight(FlightNumber,flightnumber))) && (!flightnumber.isEmpty())) {                       
                    flight_list = u.getFlights(flightnumber);
                    session.setAttribute("the_flight_list",flight_list);
                    url="/adminupdateflight.jsp";
